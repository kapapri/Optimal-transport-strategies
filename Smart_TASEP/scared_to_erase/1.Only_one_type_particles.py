...
if __name__ == '__main__': 
    ...
    if Post_training:
        ...
        one_movie = np.zeros((newL*newL*Nt + 1, newL, newL))  # All frames 
            ...
            for t in range(Nt):
                ...
                for i in range(newL*newL):
                   # Random sampling of the new lattice to apply the training
                    Xcenter = random.randint(0, newL-1)
                    Ycenter = random.randint(0, newL-1)
                    # Xcenter = 2
                    # Ycenter = 2
                    state = get_state(lattice, Xcenter, Ycenter, L, newL)
                   ...
                   # patch with the same size than the system and sampling always from the center
                    ...
                    selectedX, selectedY = get_coordinates_from_patch(patchX, patchY, Xcenter, Ycenter, L, newL)
                    # print('lattice_site', lattice_site)
        ...
        ani = create_animation(one_movie[:1000])
